...
/* The VAX C compiler cannot compile this definition */
	...
	Keyword:\"<(while|if|else|for|break|continue|return|define|in|delete)>\":::Keyword::\n\
	Braces:\"[{}]\":::Keyword::\n\
